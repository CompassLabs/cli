#
# compass CLI Installation Script for Windows
# This script downloads and installs the latest version of the compass CLI
#
# Usage:
#   iwr -useb https://raw.githubusercontent.com/CompassLabs/cli/main/scripts/install.ps1 | iex
#   or
#   Invoke-WebRequest -Uri https://raw.githubusercontent.com/CompassLabs/cli/main/scripts/install.ps1 -UseBasicParsing | Invoke-Expression
#
# Options:
#   $env:COMPASS_INSTALL_DIR - Installation directory (default: $env:LOCALAPPDATA\Programs\compass)
#   $env:COMPASS_VERSION     - Specific version to install (default: latest)
#
...
# Configuration
$Repo = "CompassLabs/cli"
$BinaryName = "compass.exe"
$DefaultInstallDir = Join-Path $env:LOCALAPPDATA "Programs\compass"
$InstallDir = if ($env:COMPASS_INSTALL_DIR) { $env:COMPASS_INSTALL_DIR } else { $DefaultInstallDir }
...
function Install-CLI {
    Write-ColorOutput "Installing compass CLI..." -Color Green
    ...
    $archiveName = "compass_Windows_$arch.zip"
    $downloadUrl = "https://github.com/$Repo/releases/download/$Version/$archiveName"

    Write-ColorOutput "Downloading from: $downloadUrl" -Color Cyan

    # Create temporary directory
    $tempDir = Join-Path $env:TEMP "compass-install-$(New-Guid)"
    ...
    try {
        ...
        Write-ColorOutput "compass $Version has been installed to $binaryPath" -Color Green
        ...
        Write-ColorOutput "Installation successful! Run 'compass --help' to get started." -Color Green
