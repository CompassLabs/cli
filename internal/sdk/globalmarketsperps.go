...
func (s *GlobalMarketsPerps) Candles(ctx context.Context, request operations.V2GlobalMarketsPerpsCandlesRequest, opts ...operations.Option) (*operations.V2GlobalMarketsPerpsCandlesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/global_markets_perps/candles")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.V2GlobalMarketsPerpsCandlesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.GlobalMarketsPerpsCandlesResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.GlobalMarketsPerpsCandlesResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *GlobalMarketsPerps) DepositSponsorPrepare(ctx context.Context, request components.GlobalMarketsPerpsDepositSponsorPrepareRequest, opts ...operations.Option) (*operations.V2GlobalMarketsPerpsDepositSponsorPrepareResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/global_markets_perps/deposit/sponsor_prepare")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.V2GlobalMarketsPerpsDepositSponsorPrepareResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.GlobalMarketsPerpsDepositSponsorPrepareResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.GlobalMarketsPerpsDepositSponsorPrepareResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *GlobalMarketsPerps) SetLeverage(ctx context.Context, request components.GlobalMarketsPerpsSetLeverageRequest, opts ...operations.Option) (*operations.V2GlobalMarketsPerpsSetLeverageResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/global_markets_perps/set_leverage")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.V2GlobalMarketsPerpsSetLeverageResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.GlobalMarketsPerpsSetLeverageResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.GlobalMarketsPerpsSetLeverageResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
