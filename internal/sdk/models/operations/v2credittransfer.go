...
func (v *V2CreditTransferResponse) GetHTTPMeta() components.HTTPMetadata {
	if v == nil {
...
func (v *V2CreditTransferResponse) GetCreditTransferResponse() *components.CreditTransferResponse {
	...
	return v.CreditTransferResponse
}

// #region class-body-v2credittransferresponse
// #endregion class-body-v2credittransferresponse
