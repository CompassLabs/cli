...
func (v *V2EarnCreateAccountResponse) GetHTTPMeta() components.HTTPMetadata {
	if v == nil {
...
func (v *V2EarnCreateAccountResponse) GetCreateAccountResponse() *components.CreateAccountResponse {
	...
	return v.CreateAccountResponse
}

// #region class-body-v2earncreateaccountresponse
// #endregion class-body-v2earncreateaccountresponse
