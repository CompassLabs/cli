...
func (u *EarnSwapRequestAmountIn) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnSwapRequestAmountIn{}
	defer func() {
		if err != nil {
			*u = previous
		}
...
func (u *EarnSwapRequestSlippage) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnSwapRequestSlippage{}
	defer func() {
		if err != nil {
			*u = previous
		}
