...
// PerpetualTradingDepositSponsorPrepareRequest - Take a user's signed EIP-2612 USDC permit and build an Arbitrum tx
...
type PerpetualTradingDepositSponsorPrepareRequest struct {
...
func (p *PerpetualTradingDepositSponsorPrepareRequest) GetOwner() string {
	if p == nil {
		return ""
	}
	return p.Owner
...
func (p *PerpetualTradingDepositSponsorPrepareRequest) GetAmountRaw() int64 {
	if p == nil {
		return 0
	}
	return p.AmountRaw
...
func (p *PerpetualTradingDepositSponsorPrepareRequest) GetDeadline() int64 {
	if p == nil {
		return 0
	}
	return p.Deadline
...
func (p *PerpetualTradingDepositSponsorPrepareRequest) GetSignature() string {
	if p == nil {
		return ""
	}
	return p.Signature
...
func (p *PerpetualTradingDepositSponsorPrepareRequest) GetSender() string {
	if p == nil {
		return ""
	}
	return p.Sender
