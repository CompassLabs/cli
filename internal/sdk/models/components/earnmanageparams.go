...
func (u *EarnManageParamsVenue) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnManageParamsVenue{}
	defer func() {
		if err != nil {
			*u = previous
		}
...
func (u *EarnManageParamsAmount) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnManageParamsAmount{}
	defer func() {
		if err != nil {
			*u = previous
		}
