...
func (l *LoopedPosition) GetSubAccountID() optionalnullable.OptionalNullable[int64] {
	if l == nil {
		return nil
	}
...
func (l *LoopedPosition) GetCollateralVault() optionalnullable.OptionalNullable[string] {
	if l == nil {
		return nil
	}
	return l.CollateralVault
}

func (l *LoopedPosition) GetBorrowVault() optionalnullable.OptionalNullable[string] {
	if l == nil {
		return nil
	}
	return l.BorrowVault
}
