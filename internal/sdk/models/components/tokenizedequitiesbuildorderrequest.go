...
// TokenizedEquitiesBuildOrderRequest - Build a buy or sell order for a tokenized equity.
type TokenizedEquitiesBuildOrderRequest struct {
...
func (t *TokenizedEquitiesBuildOrderRequest) GetFromToken() string {
	if t == nil {
		return ""
	}
	return t.FromToken
...
func (t *TokenizedEquitiesBuildOrderRequest) GetToToken() string {
	if t == nil {
		return ""
	}
	return t.ToToken
...
func (t *TokenizedEquitiesBuildOrderRequest) GetAmount() string {
	if t == nil {
		return ""
	}
	return t.Amount
...
func (t *TokenizedEquitiesBuildOrderRequest) GetOwner() string {
	if t == nil {
		return ""
	}
	return t.Owner
...
func (t *TokenizedEquitiesBuildOrderRequest) GetSlippageBps() *int64 {
	if t == nil {
		return nil
	}
