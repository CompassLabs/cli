...
func (u *CreditBorrowRequestAmountIn) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = CreditBorrowRequestAmountIn{}
	defer func() {
		if err != nil {
			*u = previous
		}
...
func (u *BorrowAmount) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = BorrowAmount{}
	defer func() {
		if err != nil {
...
func (u *CreditBorrowRequestSlippage) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = CreditBorrowRequestSlippage{}
	defer func() {
		if err != nil {
			*u = previous
		}
