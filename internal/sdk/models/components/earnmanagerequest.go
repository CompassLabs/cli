...
func (u *EarnManageRequestVenue) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnManageRequestVenue{}
	defer func() {
		if err != nil {
			*u = previous
		}
...
func (u *EarnManageRequestAmount) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnManageRequestAmount{}
	defer func() {
		if err != nil {
			*u = previous
		}
