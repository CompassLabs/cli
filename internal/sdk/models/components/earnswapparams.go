...
func (u *EarnSwapParamsAmountIn) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnSwapParamsAmountIn{}
	defer func() {
		if err != nil {
			*u = previous
		}
...
func (u *EarnSwapParamsSlippage) UnmarshalJSON(data []byte) (err error) {
	previous := *u
	*u = EarnSwapParamsSlippage{}
	defer func() {
		if err != nil {
			*u = previous
		}
