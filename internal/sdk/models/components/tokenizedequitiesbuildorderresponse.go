...
// TokenizedEquitiesBuildOrderResponse - Quote, optional approval payload, and the EIP-712 order to sign.
type TokenizedEquitiesBuildOrderResponse struct {
...
func (t TokenizedEquitiesBuildOrderResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(t, "", false)
}

func (t *TokenizedEquitiesBuildOrderResponse) UnmarshalJSON(data []byte) error {
...
func (t *TokenizedEquitiesBuildOrderResponse) GetQuote() Quote {
	if t == nil {
		return Quote{}
	}
	return t.Quote
...
func (t *TokenizedEquitiesBuildOrderResponse) GetApprovalSafeTxEip712() optionalnullable.OptionalNullable[BatchedSafeOperationsResponseOutput] {
	if t == nil {
		return nil
	}
...
func (t *TokenizedEquitiesBuildOrderResponse) GetOrder() OrderToSign {
	if t == nil {
		return OrderToSign{}
	}
	return t.Order
