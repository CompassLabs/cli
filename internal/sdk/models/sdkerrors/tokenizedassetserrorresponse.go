...
// TokenizedAssetsErrorResponse - Standard error envelope returned by every non-2xx response.
//
...
var _ error = &TokenizedAssetsErrorResponse{}

func (e *TokenizedAssetsErrorResponse) Error() string {
