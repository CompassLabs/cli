...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.882.0
...
type CompassCLI struct {
	...
	Earn                 *Earn
	Credit               *Credit
	TraditionalInvesting *TraditionalInvesting
...
func New(opts ...SDKOption) *CompassCLI {
	sdk := &CompassCLI{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.0.1 2.882.0 0.0.1 github.com/CompassLabs/cli/internal/sdk",
	...
	sdk.TraditionalInvesting = newTraditionalInvesting(sdk, sdk.sdkConfiguration, sdk.hooks)
