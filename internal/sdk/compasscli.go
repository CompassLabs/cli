...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.900.1
...
func New(opts ...SDKOption) *CompassCLI {
	sdk := &CompassCLI{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.0.1 2.900.1 0.0.1 github.com/CompassLabs/cli/internal/sdk",
