...
var swapQuoteCmdMeta = []flagutil.FlagMeta{
	{FlagName: "chain", Shorthand: "c", FieldPath: "Chain", Kind: flagutil.FlagKindEnum, Required: true, EnumValues: []string{"base", "ethereum", "arbitrum", "hyperevm", "tempo", "bsc", "ethereum_sepolia"}, Description: "Target blockchain network. (options: base, ethereum, arbitrum, hyperevm, tempo, bsc, ethereum_sepolia) [required]"},
