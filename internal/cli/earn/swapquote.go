...
var swapQuoteCmdMeta = []flagutil.FlagMeta{
	{FlagName: "chain", Shorthand: "c", FieldPath: "Chain", Kind: flagutil.FlagKindEnum, Required: true, EnumValues: []string{"arbitrum", "base", "bsc", "ethereum", "hyperevm", "tempo"}, Description: "Target blockchain network. (options: arbitrum, base, bsc, ethereum, hyperevm, tempo) [required]"},
