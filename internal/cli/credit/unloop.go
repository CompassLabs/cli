...
var unloopCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "collateral-vault", FieldPath: "CollateralVault", Kind: flagutil.FlagKindString, Optional: true, Description: "Euler only: the EVK vault the loop's collateral is in. Required when protocol=EULER."},
	{FlagName: "borrow-vault", FieldPath: "BorrowVault", Kind: flagutil.FlagKindString, Optional: true, Description: "Euler only: the EVK vault the loop borrowed from (the sub-account's controller). Required when protocol=EULER."},
