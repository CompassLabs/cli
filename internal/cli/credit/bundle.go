...
var bundleCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "chain", Shorthand: "c", FieldPath: "Chain", Kind: flagutil.FlagKindEnum, Required: true, EnumValues: []string{"arbitrum", "base", "bsc", "ethereum", "hyperevm", "tempo"}, Description: "Target blockchain network where the bundled actions will execute. (options: arbitrum, base, bsc, ethereum, hyperevm, tempo) [required]"},
...
func runBundleCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Credit.Bundle(cmd.Context(), *request, sdkOpts...)
	if err != nil {
