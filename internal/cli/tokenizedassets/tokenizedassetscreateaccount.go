...
var tokenizedAssetsCreateAccountCmdMeta = []flagutil.FlagMeta{
	{FlagName: "chain", Shorthand: "c", FieldPath: "Chain", Kind: flagutil.FlagKindEnum, Required: true, EnumValues: []string{"ethereum"}, Description: "options: ethereum [required]"},
...
func initTokenizedAssetsCreateAccountCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-assets tokenized-assets-create-account --chain ethereum --sender 0x18b42407AbC163f595410Ffe773BB98Db40B48F7 --owner 0x18b42407AbC163f595410Ffe773BB98Db40B48F7",
