...
func initCandlesCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass global-markets-perps candles --symbol AAPL --interval 1h",
		RunE:    runCandlesCmd,
	}
	flagutil.RegisterFlags(cmd, candlesCmdMeta)
	if err := flagutil.ValidateMeta[operations.V2GlobalMarketsPerpsCandlesRequest](candlesCmdMeta); err != nil {
...
func runCandlesCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.V2GlobalMarketsPerpsCandlesRequest](cmd, candlesCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.GlobalMarketsPerps.Candles(cmd.Context(), *req, sdkOpts...)
	if err != nil {
