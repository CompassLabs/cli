...
func initOpportunitiesCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass global-markets-perps opportunities",
		RunE:    runOpportunitiesCmd,
	}
	flagutil.RegisterFlags(cmd, opportunitiesCmdMeta)
	if err := flagutil.ValidateMeta[operations.V2GlobalMarketsPerpsOpportunitiesRequest](opportunitiesCmdMeta); err != nil {
...
func runOpportunitiesCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.V2GlobalMarketsPerpsOpportunitiesRequest](cmd, opportunitiesCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.GlobalMarketsPerps.Opportunities(cmd.Context(), req, sdkOpts...)
	if err != nil {
