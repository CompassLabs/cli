...
func initDepositCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[components.GlobalMarketsPerpsDepositRequest](depositCmdMeta); err != nil {
...
func runDepositCmd(cmd *cobra.Command, args []string) error {
	...
	request, err := flagutil.BuildRequest[components.GlobalMarketsPerpsDepositRequest](cmd, depositCmdMeta, "", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.GlobalMarketsPerps.Deposit(cmd.Context(), *request, sdkOpts...)
	if err != nil {
