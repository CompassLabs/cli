...
// initApproveTransferCmd initializes the approve-transfer command.
func initApproveTransferCmd(parent *cobra.Command) error {
...
// runApproveTransferCmd executes the approve-transfer command.
func runApproveTransferCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.GasSponsorship.ApproveTransfer(cmd.Context(), *request, sdkOpts...)
	if err != nil {
