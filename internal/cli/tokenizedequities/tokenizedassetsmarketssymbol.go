...
func initTokenizedAssetsMarketsSymbolCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities tokenized-assets-markets-symbol --symbol <value>",
...
func runTokenizedAssetsMarketsSymbolCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.TokenizedEquities.TokenizedAssetsMarketsSymbol(cmd.Context(), *req, sdkOpts...)
	if err != nil {
