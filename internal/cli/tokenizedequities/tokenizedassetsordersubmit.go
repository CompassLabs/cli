...
func initTokenizedAssetsOrderSubmitCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities tokenized-assets-order-submit --signed-order '{\"key\":\"<value>\"}' --signature <value> --extension m2a --quote-id <id>",
...
func runTokenizedAssetsOrderSubmitCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.TokenizedEquities.TokenizedAssetsOrderSubmit(cmd.Context(), *request, sdkOpts...)
	if err != nil {
