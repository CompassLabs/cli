...
func initOrderCancelCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities order-cancel --order-hash <value> --owner <value>",
		RunE:    runOrderCancelCmd,
		Aliases: []string{"oc"},
	}
	flagutil.RegisterFlags(cmd, orderCancelCmdMeta)
	if err := flagutil.ValidateMeta[operations.V2TokenizedEquitiesOrderOrderHashCancelRequest](orderCancelCmdMeta); err != nil {
...
func runOrderCancelCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.V2TokenizedEquitiesOrderOrderHashCancelRequest](cmd, orderCancelCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.TokenizedEquities.OrderCancel(cmd.Context(), *req, sdkOpts...)
	if err != nil {
