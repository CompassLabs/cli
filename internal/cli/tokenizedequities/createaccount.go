...
func initCreateAccountCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities create-account --sender 0x000E009dF7AD7f37421C73AE619Bc208bC71BEFC --owner 0x000E009dF7AD7f37421C73AE619Bc208bC71BEFC",
		RunE:    runCreateAccountCmd,
		Aliases: []string{"ca"},
	}
	flagutil.RegisterFlags(cmd, createAccountCmdMeta)
	if err := flagutil.ValidateMeta[components.CreateTokenizedEquitiesAccountRequest](createAccountCmdMeta); err != nil {
...
func runCreateAccountCmd(cmd *cobra.Command, args []string) error {
	...
	request, err := flagutil.BuildRequest[components.CreateTokenizedEquitiesAccountRequest](cmd, createAccountCmdMeta, "", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.TokenizedEquities.CreateAccount(cmd.Context(), *request, sdkOpts...)
	if err != nil {
