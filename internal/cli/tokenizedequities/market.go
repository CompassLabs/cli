...
func initMarketCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities market --symbol <value>",
		RunE:    runMarketCmd,
	}
	flagutil.RegisterFlags(cmd, marketCmdMeta)
	if err := flagutil.ValidateMeta[operations.V2TokenizedEquitiesMarketsSymbolRequest](marketCmdMeta); err != nil {
...
func runMarketCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.V2TokenizedEquitiesMarketsSymbolRequest](cmd, marketCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.TokenizedEquities.Market(cmd.Context(), *req, sdkOpts...)
	if err != nil {
