...
func initPositionsCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities positions --owner 0x29F20a192328eF1aD35e1564aBFf4Be9C5ce5f7B",
		RunE:    runPositionsCmd,
	}
	flagutil.RegisterFlags(cmd, positionsCmdMeta)
	if err := flagutil.ValidateMeta[operations.V2TokenizedEquitiesPositionsRequest](positionsCmdMeta); err != nil {
...
func runPositionsCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.V2TokenizedEquitiesPositionsRequest](cmd, positionsCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.TokenizedEquities.Positions(cmd.Context(), *req, sdkOpts...)
	if err != nil {
