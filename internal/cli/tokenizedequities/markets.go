...
func initMarketsCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  compass tokenized-equities markets",
		RunE:    runMarketsCmd,
	}
	flagutil.RegisterFlags(cmd, marketsCmdMeta)
	if err := flagutil.ValidateMeta[operations.V2TokenizedEquitiesMarketsRequest](marketsCmdMeta); err != nil {
...
func runMarketsCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.V2TokenizedEquitiesMarketsRequest](cmd, marketsCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.TokenizedEquities.Markets(cmd.Context(), req, sdkOpts...)
	if err != nil {
