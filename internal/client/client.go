...
import (
	...
	"github.com/CompassLabs/cli/internal/testclient"
...
func NewClient(cmd *cobra.Command, allowedSecurityFields ...string) (*sdk.CompassCLI, error) {
...
func buildGlobalSecurity(cmd *cobra.Command, allowedSecurityFields []string) components.Security {
	...
	apiKeyAuth, _ := config.ResolveRequestSecurityCredential(cmd, "api-key-auth")
