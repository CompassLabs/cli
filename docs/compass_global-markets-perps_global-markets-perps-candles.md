## compass global-markets-perps global-markets-perps-candles
...
```
compass global-markets-perps global-markets-perps-candles [flags]
```

### Examples

```
  compass global-markets-perps global-markets-perps-candles --symbol AAPL --interval 1h
```
...
```
  ...
  -h, --help                help for global-markets-perps-candles
