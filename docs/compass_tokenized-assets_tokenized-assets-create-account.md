...
```
  compass tokenized-assets tokenized-assets-create-account --chain ethereum --sender 0x18b42407AbC163f595410Ffe773BB98Db40B48F7 --owner 0x18b42407AbC163f595410Ffe773BB98Db40B48F7
```
...
```
  ...
  -c, --chain string    options: ethereum [required]
