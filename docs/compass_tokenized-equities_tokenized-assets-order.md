## compass tokenized-equities tokenized-assets-order
...
```
compass tokenized-equities tokenized-assets-order [flags]
```

### Examples

```
  compass tokenized-equities tokenized-assets-order --from-token <value> --to-token <value> --amount 853.30 --owner <value>
```
