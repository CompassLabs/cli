## compass global-markets-perps positions
...
```
compass global-markets-perps positions [flags]
```

### Examples

```
  compass global-markets-perps positions --owner 0x01E62835dd7F52173546A325294762143eE4a882
```
