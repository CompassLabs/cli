...
```
compass credit balances [flags]
```

### Examples

```
  compass credit balances --chain base --owner 0x01E62835dd7F52173546A325294762143eE4a882
```
...
* `compass credit balances --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `compass credit balances --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
