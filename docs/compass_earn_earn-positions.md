...
```
compass earn earn-positions [flags]
```

### Examples

```
  compass earn earn-positions --chain base --owner 0x01E62835dd7F52173546A325294762143eE4a882
```
...
```
  ...
  -h, --help           help for earn-positions
