## compass global-markets-perps execute
...
```
compass global-markets-perps execute [flags]
```

### Examples

```
  compass global-markets-perps execute --action '{"key":"<value>","key1":"<value>"}' --nonce 511479 --signature <value>
```
