## compass tokenized-equities tokenized-assets-markets-symbol
...
```
compass tokenized-equities tokenized-assets-markets-symbol [flags]
```

### Examples

```
  compass tokenized-equities tokenized-assets-markets-symbol --symbol <value>
```
