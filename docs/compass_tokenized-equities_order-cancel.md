## compass tokenized-equities order-cancel
...
```
compass tokenized-equities order-cancel [flags]
```

### Examples

```
  compass tokenized-equities order-cancel --order-hash <value> --owner <value>
```
