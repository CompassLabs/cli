## compass tokenized-equities tokenized-assets-order-submit
...
```
compass tokenized-equities tokenized-assets-order-submit [flags]
```

### Examples

```
  compass tokenized-equities tokenized-assets-order-submit --signed-order '{"key":"<value>"}' --signature <value> --extension m2a --quote-id <id>
```
