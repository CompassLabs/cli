## compass gas-sponsorship gas-sponsorship-approve-transfer
...
```
compass gas-sponsorship gas-sponsorship-approve-transfer [flags]
```

### Examples

```
  compass gas-sponsorship gas-sponsorship-approve-transfer --owner 0x01E62835dd7F52173546A325294762143eE4a882 --chain base --token USDT
```
...
```
  ...
  -h, --help                   help for gas-sponsorship-approve-transfer
