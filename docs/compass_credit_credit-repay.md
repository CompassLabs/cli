...
```
compass credit credit-repay [flags]
```

### Examples

```
  compass credit credit-repay --owner 0x831Ad0C52C77708DA5D49dc8278C966dfdD4ddA1 --chain base --repay-token WETH --repay-amount 0.01
```
