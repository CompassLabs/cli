## compass tokenized-equities tokenized-equities-quote
...
```
compass tokenized-equities tokenized-equities-quote [flags]
```

### Examples

```
  compass tokenized-equities tokenized-equities-quote --from-token <value> --to-token <value> --amount 936.80 --owner <value>
```
...
```
  ...
  -h, --help                  help for tokenized-equities-quote
