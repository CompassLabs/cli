...
```
compass earn earn-transfer [flags]
```

### Examples

```
  compass earn earn-transfer --owner 0x01E62835dd7F52173546A325294762143eE4a882 --chain base --token USDC --amount 0.01 --action DEPOSIT
```
