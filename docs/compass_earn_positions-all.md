...
```
compass earn positions-all [flags]
```

### Examples

```
  compass earn positions-all --owner 0x01E62835dd7F52173546A325294762143eE4a882
```

### Options

```
  -h, --help           help for positions-all
...
* `compass earn positions-all --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `compass earn positions-all --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
