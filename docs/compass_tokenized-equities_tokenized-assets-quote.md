## compass tokenized-equities tokenized-assets-quote
...
```
compass tokenized-equities tokenized-assets-quote [flags]
```

### Examples

```
  compass tokenized-equities tokenized-assets-quote --from-token <value> --to-token <value> --amount 226.42 --owner <value>
```
