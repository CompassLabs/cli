## compass tokenized-equities create-account
...
```
compass tokenized-equities create-account [flags]
```

### Examples

```
  compass tokenized-equities create-account --sender 0x000E009dF7AD7f37421C73AE619Bc208bC71BEFC --owner 0x000E009dF7AD7f37421C73AE619Bc208bC71BEFC
```
