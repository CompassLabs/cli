...
```
compass credit credit-bundle [flags]
```

### Examples

```
  compass credit credit-bundle --owner <value> --chain arbitrum --actions '[{"body":{"action_type":"V2_TRANSFER_FROM_EOA","token":"<value>","amount":"709.93","permit2_signature":"<value>","permit2_nonce":210517,"permit2_deadline":120606} }]'
```
