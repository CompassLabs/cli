## compass global-markets-perps ensure-leverage
...
```
compass global-markets-perps ensure-leverage [flags]
```

### Examples

```
  compass global-markets-perps ensure-leverage --owner <value> --asset <value>
```
