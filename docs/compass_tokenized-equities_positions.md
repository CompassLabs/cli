## compass tokenized-equities positions
...
```
compass tokenized-equities positions [flags]
```

### Examples

```
  compass tokenized-equities positions --owner 0x29F20a192328eF1aD35e1564aBFf4Be9C5ce5f7B
```
