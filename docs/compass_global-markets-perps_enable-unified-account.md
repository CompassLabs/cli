## compass global-markets-perps enable-unified-account
...
```
compass global-markets-perps enable-unified-account [flags]
```

### Examples

```
  compass global-markets-perps enable-unified-account --owner <value>
```
