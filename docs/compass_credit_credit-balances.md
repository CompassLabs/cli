## compass credit credit-balances
...
```
compass credit credit-balances [flags]
```

### Examples

```
  compass credit credit-balances --chain base --owner 0x01E62835dd7F52173546A325294762143eE4a882
```
...
```
  ...
  -h, --help           help for credit-balances
