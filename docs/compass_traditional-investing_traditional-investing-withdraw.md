## compass traditional-investing traditional-investing-withdraw

Withdraw USDC from traditional investments account
...
```
compass traditional-investing traditional-investing-withdraw [flags]
```

### Examples

```
  compass traditional-investing traditional-investing-withdraw --owner 0x01E62835dd7F52173546A325294762143eE4a882 --amount 100.0
```
...
```
  ...
  -h, --help                 help for traditional-investing-withdraw
      --owner string         The user's EOA address (owner of the traditional investing account) [required]
```
