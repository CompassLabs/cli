## compass tokenized-equities tokenized-assets-order-order-hash
...
```
compass tokenized-equities tokenized-assets-order-order-hash [flags]
```

### Examples

```
  compass tokenized-equities tokenized-assets-order-order-hash --order-hash <value>
```
