## compass credit credit-transfer
...
```
compass credit credit-transfer [flags]
```

### Examples

```
  compass credit credit-transfer --owner 0x4A83fec8c6A9A25Be28f3242a16dBaD0ab00f3a6 --chain base --token USDC --amount 100 --action DEPOSIT
```
...
```
  ...
  -h, --help                   help for credit-transfer
