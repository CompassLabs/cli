## compass risk-yield risk-yield-increase
...
```
compass risk-yield risk-yield-increase [flags]
```

### Examples

```
  compass risk-yield risk-yield-increase --owner 0x06A9aF046187895AcFc7258450B15397CAc67400 --position-id 1076416 --deposit '{"type":"both","amount0":"50","amount1":"0.02"}'
```
...
```
  ...
  -h, --help                    help for risk-yield-increase
      --owner string            The wallet that owns the Risk Yield Account. [required]
      --position-id int         The position NFT's id. [required]
