## compass credit looped-positions
...
```
  compass credit looped-positions --chain base --owner 0x06A9aF046187895AcFc7258450B15397CAc67400
```
...
* `compass credit looped-positions --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `compass credit looped-positions --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
