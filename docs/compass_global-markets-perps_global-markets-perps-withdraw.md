## compass global-markets-perps global-markets-perps-withdraw
...
```
compass global-markets-perps global-markets-perps-withdraw [flags]
```

### Examples

```
  compass global-markets-perps global-markets-perps-withdraw --owner 0x01E62835dd7F52173546A325294762143eE4a882 --amount 100.0
```
...
```
  ...
  -h, --help                 help for global-markets-perps-withdraw
