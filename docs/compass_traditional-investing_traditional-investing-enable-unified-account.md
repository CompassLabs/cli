## compass traditional-investing traditional-investing-enable-unified-account
...
```
compass traditional-investing traditional-investing-enable-unified-account [flags]
```

### Examples

```
  compass traditional-investing traditional-investing-enable-unified-account --owner <value>
```
...
```
  ...
  -h, --help           help for traditional-investing-enable-unified-account
