## compass earn earn-create-account
...
```
compass earn earn-create-account [flags]
```

### Examples

```
  compass earn earn-create-account --chain base --sender 0x01E62835dd7F52173546A325294762143eE4a882 --owner 0x01E62835dd7F52173546A325294762143eE4a882
```
...
```
  ...
  -h, --help            help for earn-create-account
