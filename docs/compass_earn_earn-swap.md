...
```
compass earn earn-swap [flags]
```

### Examples

```
  compass earn earn-swap --token-in USDC --token-out USDT --amount-in 0.01 --owner 0x01E62835dd7F52173546A325294762143eE4a882 --chain base
```
