## compass credit credit-create-account
...
```
compass credit credit-create-account [flags]
```

### Examples

```
  compass credit credit-create-account --chain base --sender 0xc98949522db2eE403d6c75E91DDEe875a824bB10 --owner 0xc98949522db2eE403d6c75E91DDEe875a824bB10
```
...
```
  ...
  -h, --help            help for credit-create-account
